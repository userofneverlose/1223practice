...
from app.schemas import (CurrencyCreate, CurrencyResponse, ExchangeRateCreate,
...
app.add_middleware(
    ...
    allow_origins=[
        ...
        "http://127.0.0.1:3000",
        "https://yourdomain.com",  # Production домен (замени на свой)
    ],
...
def convert(
    ...
    # Можно добавить заголовок с методом расчёта (для отладки)
    return response
...
def get_mobile_rates(
    ...
    """Эндпоинт для мобильных приложений. Возвращает только необходимые поля."""
